<?php
  ...
  function top_bar_html($title = "Default Title", $desc = "Default Description", $img = "/images/fallback.jpg") {
      ...
      <header>
        <nav id="root_nav">
          <nav id="primary_nav">  
            ...
            <a href="competitions">Perlombaan</a>
          ...
          <nav id="user_menu">
            <span id="signed_account">
              <a id="profile_pic" href="profile">
                <img src="../../assets/images/default_pfp.jpg" alt="default_pfp.jpg">
              </a>
